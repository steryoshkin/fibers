...
function get_node($node,$node_old)
{
    global $table_cable;
    global $table_pq;
    global $table_node;
    ...
    $sql = "SELECT n1.id AS node_id_1, n2.id AS node_id_2, n1.address AS n1, n2.address AS n2, n1.id AS n1_id, n2.id AS n2_id, c_t.name AS cable_name, c_t.fib AS cable_fib
        ...
        WHERE ".(isset($_GET['id'])?"p1.node = ".$node." AND p2.node != ".$node_old." AND":"")." p2.id = IF(c1.pq_1=p1.id,c1.pq_2,IF(c1.pq_2=p1.id,c1.pq_1,NULL))
        AND p1.node = n1.id
        AND p2.node = n2.id
            ...
            graphics.node(function(node) {
              // This time it's a group of elements: http://www.w3.org/TR/SVG/struct.html#Groups
                ...
                $(ui).dblclick(function(e) { // mouse over
                    window.open('http://62.231.168.109/fibers/index.php?act=s_pq&o_node&node_id='+node.data[1]);
                	/*var ttt = node;
